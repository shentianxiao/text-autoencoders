...
# Training arguments
parser.add_argument('--model', default='aae', metavar='M',
                    choices=['ae', 'vae', 'aae'],
                    help='which model to learn')
parser.add_argument('--lambda_kl', type=float, default=0.1, metavar='R',
...
parser.add_argument('--noise', default='0,0.3,0,0', metavar='P,P,P,K',
...
def main(args):
    ...
    model = {'ae': AE, 'vae': VAE, 'aae': AAE}[args.model](
